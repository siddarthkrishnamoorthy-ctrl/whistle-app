...
const TABS: { key: string; label: string; path: string; icon: IconName; iconActive: IconName }[] = [
  { key: "home", label: "Home", path: "/parent/home", icon: "home-outline", iconActive: "home" },
  { key: "child", label: "My Child", path: "/parent/child", icon: "happy-outline", iconActive: "happy" },
  { key: "progress", label: "Progress", path: "/parent/progress", icon: "trending-up-outline", iconActive: "trending-up" },
  { key: "events", label: "Matches", path: "/parent/events", icon: "trophy-outline", iconActive: "trophy" },
  { key: "chess", label: "Chess", path: "/parent/chess", icon: "grid-outline", iconActive: "grid" },
  { key: "scrabble", label: "Scrabble", path: "/parent/scrabble", icon: "text-outline", iconActive: "text" },
  { key: "profile", label: "Profile", path: "/parent/profile", icon: "person-outline", iconActive: "person" },
];
