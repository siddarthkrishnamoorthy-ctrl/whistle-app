...
// Self-registration is the parent flow (signUp hits /auth/signup-parent). Coach
// accounts are provisioned by an academy admin, so the login screen routes
// coaches to an invite explanation instead of here.
  ...
  return (
    <KeyboardAvoidingView style={{ flex: 1 }} behavior={Platform.OS === "ios" ? "padding" : undefined}>
      <ScrollView contentContainerStyle={{ flexGrow: 1, justifyContent: "center", padding: 24 }}>
        ...
        <Text style={{ color: colors.textPrimary, fontSize: 20, fontWeight: "700", marginBottom: 4 }}>Create your parent account</Text>
        <Text style={{ color: colors.textSecondary, marginBottom: 24 }}>Follow your child&apos;s training, ratings and matches</Text>
