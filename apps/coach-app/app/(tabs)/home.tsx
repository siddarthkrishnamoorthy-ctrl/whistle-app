  ...
  return (
    <ScrollView contentContainerStyle={{ padding: 20, gap: 16 }}>
      ...
      <View style={{ flexDirection: "row", flexWrap: "wrap", gap: 10 }}>
        <QuickLink label="Host Match" icon="trophy-outline" onPress={() => router.push("/events/new")} />
        <QuickLink label="Lesson Plans" icon="book-outline" onPress={() => router.push("/lessons")} />
        <QuickLink label="Drill Bank" icon="fitness-outline" onPress={() => router.push("/drills")} />
        <QuickLink label="Standings" icon="podium-outline" onPress={() => router.push("/ratings")} />
      </View>
