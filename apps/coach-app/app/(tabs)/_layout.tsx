...
const TABS: { key: string; label: string; path: string; icon: IconName; iconActive: IconName }[] = [
  { key: "home", label: "Home", path: "/home", icon: "home-outline", iconActive: "home" },
  { key: "classes", label: "Classes", path: "/classes", icon: "school-outline", iconActive: "school" },
  { key: "schedule", label: "Schedule", path: "/schedule", icon: "calendar-outline", iconActive: "calendar" },
  { key: "assessments", label: "Assess", path: "/assessments", icon: "clipboard-outline", iconActive: "clipboard" },
  { key: "lessons", label: "Lessons", path: "/lessons", icon: "book-outline", iconActive: "book" },
  { key: "events", label: "Matches", path: "/events", icon: "trophy-outline", iconActive: "trophy" },
  { key: "ratings", label: "Standings", path: "/ratings", icon: "podium-outline", iconActive: "podium" },
